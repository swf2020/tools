...
DASHSCOPE_API_KEY = os.environ.get("DASHSCOPE_API_KEY", "sk-sp-")
...
class AppLogger:
    def __init__(self, log_file: str = "claude_code_to_llm_proxy.log"):
...
logger = AppLogger("claude_code_to_llm_proxy.log")
